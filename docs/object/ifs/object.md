...
digraph {
    ...
    HsRegExp [tooltip="HsRegExp", URL="HsRegExp.md", label="{HsRegExp}"];
    ...
    RadosCluster [tooltip="RadosCluster", URL="RadosCluster.md", label="{RadosCluster}"];
    RadosIoCtx [tooltip="RadosIoCtx", URL="RadosIoCtx.md", label="{RadosIoCtx}"];
    RadosStat [tooltip="RadosStat", URL="RadosStat.md", label="{RadosStat}"];
    ...
    Stats [tooltip="Stats", URL="Stats.md", label="{Stats}"];
