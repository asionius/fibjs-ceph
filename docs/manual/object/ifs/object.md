...
digraph {
    ...
    PKey [tooltip="PKey", URL="PKey.md", label="{PKey|new PKey()\l|name\lkeySize\lpublicKey\l|genRsaKey()\lgenEcKey()\lisPrivate()\lclone()\limportKey()\limportFile()\lexportPem()\lexportDer()\lexportJson()\lencrypt()\ldecrypt()\lsign()\lverify()\l}"];
    ...
    RadosCluster [tooltip="RadosCluster", URL="RadosCluster.md", label="{RadosCluster|new RadosCluster()\l|connect()\lcreatePool()\llistPool()\ldeletePool()\lcreateIoCtx()\lshutdown()\l}"];
    RadosIoCtx [tooltip="RadosIoCtx", URL="RadosIoCtx.md", label="{RadosIoCtx|createImage()\lcloneImage()\lremoveImage()\lrenameImage()\llistImages()\lopenImage()\lversion()\lopen()\lremove()\lcreateSnap()\lremoveSnap()\lrollbackSnap()\llistOids()\lgetXattr()\lsetXattr()\lrmXattr()\lgetXattrs()\ldestroy()\l}"];
    RadosStat [tooltip="RadosStat", URL="RadosStat.md", label="{RadosStat|size\lmtime\l}"];
